  ...
  <div class="modal" id="AddCars">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="form-group">
            <label>Color</label>
            <input required class="form-control" name="color" placeholder="Color">
        </div>

         <div class="form-group">
            <label>Image Of Car <small style="color: red"></small> </label>
   ...
   <div class="modal" id="Editcar-{{$car->id}}">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="form-group">
            <label>Color</label>
            <input required class="form-control" name="color" placeholder="Color"  value="{{$car->color}}">
        </div>
