...
<center>
  <h1>Kend Rent Car</h1>
  <p>Jl. Tj. Raya II Komp vila kurnia No.B 20, Ds. Kapur, Kec. Sungai Raya, Kab. Kubu Raya, Kalimantan Barat 78234</p>
  <br>
</center>
<h5>Report Data Lease date : {{$lease}} , Return : {{$return}}</h4>
      ...
      <p align="right"> Data From {{url('/')}}</p>
			<p align="right"> Generate at {{$now}}</p>
		</body>
		</html>