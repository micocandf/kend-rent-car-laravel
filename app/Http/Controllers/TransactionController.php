...
use App\Models\Bank;
use App\Models\User;
use App\Mail\PemesananMobil;
use App\Mail\PesananSetuju;
use Auth;
use Carbon\Carbon;
...
class TransactionController extends Controller
{
    ...
    public function createOnline(Request $request)
    {
        ...
        $Transactions->return_time = $request->return_time;
        ...
        // \Mail::to(Auth::user()->email)->send(new PemesananMobil);
    ...
    public function changeStatus($id,$status)
    {
        ...
        if($status=='agree')
        {
            ...
            //  \Mail::to($transactions->user->email)->send(new PesananSetuju);
        }
        $transactions->save();
