...
<head>
    ...
    <title>KEND RENT CAR - Login</title>
                ...
                <div class="panel-body">
                    <form role="form" method="POST" action="{{route('login')}}">
                        ...
                        <fieldset>
                            ...
                            If forgot the password , you can contact administator by click this wahtsapp contact. &nbsp;
                            <a target="_blank" href="https://wa.link/fjtix3"> <i style="cursor: pointer;" class="fa fa-whatsapp"></i></a>
                            <p align="right">
                            <br>
